...
<table width="200" border="0" background="img/image.jpg">
  ...
  <tr>
    ...
    <td><label for="textfield5"></label>
      <input type="text" name="dni" id="textfield5" value="" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><input type="button" name="button" id="button" value="Guardar" onclick="Enviar('propietario.php?cod1='+form1.cod.value+'&nom1='+form1.nom.value+'&ape1='+form1.ape.value+'&dir1='+form1.dir.value+'&dni1='+form1.dni.value+'&gen1='+form1.gen.value+'&ident=1','cuerpo')" /></td>
