...
<?php
	...
	$sql = "select * from seguridadtmas";
	$rs = mysql_query($sql);
	$n = mysql_num_rows($rs);
?>	
<table width="900" border="1" bgcolor="#CCCCCC" background="img/imagecan.jpg">
  <tr>
    <td>codigo</td>
    <td>Nombre</td>
    <td>fecha</td>
...
?>
    ...
    <td><?php echo mysql_result($rs,$i,"codtipom");?></td>
    <td><?php echo mysql_result($rs,$i,"nomtpom");?></td>
