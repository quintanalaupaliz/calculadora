...
<table width="200" border="0" background="img/imageca.jpg">
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <td><label for="textfield3"></label>
      <input type="text" name="uni" id="textfield3" /></td>
  </tr>
  <tr>
    <td align="right">color</td>
    <td><label for="textfield4"></label>
      <input type="text" name="car" id="textfield4" /></td>
  </tr>
  <tr>
    <td align="right">fecha</td>
    <td><label for="textfield5"></label>
      <input type="text" name="pre" id="textfield5" value="<?php echo date("Y/m/d")?>" /></td>
  </tr>
  <tr>
    <td align="right">Tamaño</td>
    <td><label for="textfield6"></label>
      <input type="text" name="sto" id="textfield6" /></td>
  </tr>
  <tr>
    <td align="right">Peso</td>
    <td><label for="textfield7"></label>
      <input type="text" name="dni" id="textfield7" /></td>
  </tr>
  <tr>
    <td align="right">Edad</td>
    <td><label for="textfield8"></label>
      <input type="text" name="ema" id="textfield8" /></td>
  </tr>
   <tr>
    <td align="right">Observa.</td>
    <td><label for="textfield9"></label>
      <input type="text" name="obs" id="textfield9" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><input type="button" name="button" id="button" value="Guardar" onclick="Enviar('mascota.php?cod1='+form1.cod.value+'&nom1='+form1.nom.value+'&uni1='+form1.uni.value+'&car1='+form1.car.value+'&pre1='+form1.pre.value+'&sto1='+form1.sto.value+'&dni1='+form1.dni.value+'&ema1='+form1.ema.value+'&obs1='+form1.obs.value+'&tpo1='+form1.tpo.value+'&pro1='+form1.pro.value+'&ident=1','cuerpo')" /></td>
