...
<table width="200" border="0" background="img/imagecan.jpg">
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    <td><input type="button" name="button" id="button" value="Guardar" onclick="Enviar('tipomascota.php?cod1='+form1.cod.value+'&nom1='+form1.nom.value+'&ident=1','cuerpo')" /></td>
